...
current focus on Colorlight i5-v7.0 and i9-v7.2, i9plus-v6.0,  check [get-start](./get-start.md) to see how to setup the env and program the bitstream.  
...
the Colorlight i9plus-v6.0 contain a XC7A50T-FGG484, all GPIO already reversed, check [Colorlight i9plus-v6.0](colorlight_i9plus_v6.0.md) to see the detail.
